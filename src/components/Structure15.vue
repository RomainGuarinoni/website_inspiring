<template>
  <div class="box">
    ...
    <!-- Audio à insérer-->
    <audio src="../assets/audio_structure/20201212215929.mp3" controls></audio>
    <p>
      Ci-dessous, le chiffre du haut est 2, il y a l'équivalent de 2 noires par
      mesure.
    </p>
    <p>
    ...
    <div class="boutons">
      ...
      <div class="right">
        <p class="link" @click="nav('structure14')">Page précédente</p>
        <p class="link" @click="nav('structure16')">Page suivante</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted: function() {
    ...
    const div2 = document.getElementById("porteeChiffrage24");
    ...
    var voice4 = new Vex.Flow.Voice({ num_beats: 2, beat_value: 4 });
    var voice5 = new Vex.Flow.Voice({ num_beats: 2, beat_value: 4 });

    //voix rajoutées pour le texte
    var voice51 = new Vex.Flow.Voice({ num_beats: 2, beat_value: 4 });
    ...
    var text133 = new Vex.Flow.TextNote({
      text: "=",
      duration: "8",
    })
      .setLine(16)
    ...
    var text144 = new Vex.Flow.TextNote({
      text: "2 temps ",
      duration: "qd",
    })
      .setLine(16)
    ...
    voice51.addTickables([text133]);
    voice51.addTickables([text144]);

    //On formatte et on joint les deux voix
    // eslint-disable-next-line no-unused-vars
    var formatter = new Vex.Flow.Formatter()
      .joinVoices([voice4, voice5, voice51])
      .format([voice4, voice5, voice51], 180);
    ...
    text133.setContext(context2).draw();
    text144.setContext(context2).draw();
    ...
    var staveMeasure3 = new Vex.Flow.Stave(260, 0, 200);

    //On l'ajoute au contexte et on la dessine
    staveMeasure3.setContext(context2).draw();

    //voix
    var voice6 = new Vex.Flow.Voice({ num_beats: 2, beat_value: 4 });
    var voice7 = new Vex.Flow.Voice({ num_beats: 2, beat_value: 4 });
    ...
    var staveMeasure4 = new Vex.Flow.Stave(460, 0, 200);

    //On l'ajoute au contexte et on la dessine
    staveMeasure4.setContext(context2).draw();

    //voix
    var voice8 = new Vex.Flow.Voice({ num_beats: 2, beat_value: 4 });
    var voice9 = new Vex.Flow.Voice({ num_beats: 2, beat_value: 4 });
    var voice91 = new Vex.Flow.Voice({ num_beats: 2, beat_value: 4 });
    ...
    var text433 = new Vex.Flow.TextNote({
      text: "=",
      duration: "8",
    })
      .setLine(16)
    ...
    var text444 = new Vex.Flow.TextNote({
      text: "2 temps",
      duration: "qd",
    })
      .setLine(16)
    ...
    voice91.addTickables([text433]);
    voice91.addTickables([text444]);
    // eslint-disable-next-line no-unused-vars
    var formatter4 = new Vex.Flow.Formatter()
      .joinVoices([voice8, voice9, voice91])
      .format([voice8, voice9, voice91], 180);
    ...
    text433.setContext(context2).draw();
    text444.setContext(context2).draw();
    ...
    var staveMeasure2 = new Vex.Flow.Stave(660, 0, 200);
    ...
    //voix
    var voice2 = new Vex.Flow.Voice({ num_beats: 2, beat_value: 4 });
    var voice3 = new Vex.Flow.Voice({ num_beats: 2, beat_value: 4 });
