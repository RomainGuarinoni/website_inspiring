<template>
  <div class="box">
    ...
    <audio src="../assets/nuance1.mp3" controls></audio>
    <p>
      Souviens-toi : les nuances correspondent à différents niveaux d’intensité
      de la musique, et s’écrivent en dessous de la portée:
    </p>
    <div id="nuance_portée"></div>
    <audio src="../assets/nuance2.mp3" controls></audio>
    <p>Mais que signifient-elles ?</p>
    ...
    <div class="boutons">
      ...
      <div class="right">
        ...
        <p class="link" @click="nav('Nuance2')">Page suivante</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted: function() {
    // on place la portée
    const monDiv = document.getElementById("nuance_portée");
