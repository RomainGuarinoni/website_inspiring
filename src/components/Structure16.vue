<template>
  <div class="box">
    ...
    <!-- Audio à insérer-->
    <audio src="../assets/audio_structure/20201212220007.mp3" controls></audio>
    ...
    <div class="boutons">
      ...
      <div class="right">
        <p class="link" @click="nav('structure15')">Page précédente</p>
        <p class="link" @click="nav('structure17')">Page suivante</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted: function() {
    ...
    const div2 = document.getElementById("porteeChiffrage24Pulsations");
    ...
    var staveMeasure1 = new Vex.Flow.Stave(10, 0, 240);
    ...
    var staveMeasure3 = new Vex.Flow.Stave(250, 0, 150);
    ...
    var staveMeasure4 = new Vex.Flow.Stave(400, 0, 180);
    ...
    var staveMeasure2 = new Vex.Flow.Stave(580, 0, 150);
