<template>
  <div class="box">
    ...
    <div id="rythme_portee7"></div>
    <div class="boutons">
      <div class="left">
        <p class="link" @click="nav('rythme')">Retour au menu</p>
      </div>
      <div class="right">
        <p class="link" @click="nav('rythme7')">Page précédente</p>
        <p class="link" @click="nav('rythme9')">Page suivante</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted: function() {
    // on place la portée
    const monDiv = document.getElementById("rythme_portee7");
