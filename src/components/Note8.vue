<template>
  <div class="box">
    ...
    <h2>Le Si</h2>
    <audio src="@/assets/Note/Si.mp3" controls></audio>
    <div id="note_portee_si"></div>
    <div class="boutons">
      <div class="left">
      ...
      <div class="right">
        ...
        <p class="link" @click="nav('Note9')">Page suivante</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted: function() {
    // on place la portée
    const monDiv = document.getElementById("note_portee_si");
    ...
    notesMesure_2[2].setStyle({ fillStyle: "red", strokeStyle: "red" });
