<template>
  <div class="box">
    ...
    <h2>Le La</h2>
    <audio src="@/assets/Note/La.mp3" controls></audio>
    <div id="note_portee_la"></div>
    <p>
    ...
    <div class="boutons">
      ...
      <div class="right">
        <p class="link" @click="nav('Note6')">Page précédente</p>
        <p class="link" @click="nav('Note8')">Page suivante</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted: function() {
    // on place la portée
    const monDiv = document.getElementById("note_portee_la");
    ...
    notesMesure_2[1].setStyle({ fillStyle: "red", strokeStyle: "red" });
