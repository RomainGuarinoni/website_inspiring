<template>
  <div class="box">
    ...
    <!-- Audio à insérer-->
    <audio src="../assets/audio_structure/20201212220149.mp3" controls></audio>

    <p>
      *mascotte* : Tu peux écouter le morceau ci-dessous et identifier les
      nuances: *audio*
    </p>
    ...
    <div class="boutons">
      ...
      <div class="right">
        <p class="link" @click="nav('structure18')">Page précédente</p>
        <p class="link" @click="nav('partition')">Terminer le cours</p>
      </div>
    </div>
  </div>
</template>
